...
// Turnover storekeeper build upon turnover customer
// Can be refactored to reuse code
// Can be change url to another endpoint
// Can be change data to another data
