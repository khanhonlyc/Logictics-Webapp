...
import DetailService from "../../components/Admin/Service/DetailService";
import AdminAddService from "../../components/Admin/Service/AddService";
import AdminEditService from "../../components/Admin/Service/EditService";
...
function AdminDeliveryService() {
  ...
  const handleClickDetail = (record) => {
    const [dataDetail] = data.filter((ele) => ele._id === record._id);
    setDataForDetail(dataDetail);
  };
