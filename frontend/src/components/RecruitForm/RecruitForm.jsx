...
const RecruitForm = ({ id }) => {
  ...
  return (
    <Formik className="pb-[5px]">
      {() => {
        return (
          <div className="bg-[#fff] p-3 sm:p-7 lg:p-14 w-[90%]  lg:w-auto rounded-lg absolute top-[30px] left-[50%]  translate-x-[-50%]">
            <h3 className="mb-2 text-3xl font-bold lg:mb-5">
              Đăng ký ứng tuyển
            </h3>
            <Form
            ...
            >
              ...
              <FormGroup className=" col-span-full">
                <button
                  type="submit"
                  className="w-[100%] bg-[#e5a663] py-2 sm:mt-5 rounded-lg"
                >
                  Gửi đăng ký ứng tuyển
                </button>
                <p className="mt-2 text-xl text-green-400 text-center p-[3px]">
                  {inform}
                </p>
              </FormGroup>
            </Form>
